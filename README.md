...
API END POINTS
POST /questions/{id}
creates a new question and returns a list of questions.
example:
...
GET/categories
returns list of categories, paginated into 10 items per page.
...
returns a list of questions in each category paginated into 10 per page.
